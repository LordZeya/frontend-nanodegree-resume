...
/*
	for (onlineCourses in education.onlineCourses) {
		...
		var formattedOnlineTitle = HTMLonlineTitle.replace("%data%", education.onlineCourses[onlineCourses]);
		$("")
	}
	*/
}
